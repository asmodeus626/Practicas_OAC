...
input_rev: .space 500 #Espacio para guardar el input de la reversa.
res_rev:   .space 500 #Espacio para guardar el resultado de la reversa.
...
# A partir de aquí comparamos si comando es igual a "cat"
    ...
    jal cat #Si las cadenas son iguales ejecutamos rev
    b main #Salto incondicional a main
continue4:
...
cat:
    ...
    li $v0, 4 #Código para imprimir un string
    la $a0, desccat #Cargo la dirección del prompt en a0
    syscall
...
rev1: #Se llama si rev se ejecuta sin argumentos.
    ...
    li $a1, 500 #Tamaño máximo del input
...
rev2: #Se llama si rev se ejecuta con argumentos.
    ...
    li $a2, 500 #Máximo número de caracteres que se pueden leer.
    syscall #Lee
